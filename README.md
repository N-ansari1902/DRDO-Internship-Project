...
Next Steps
We are currently focused on using the cGAN-generated data to test and validate various target detection and tracking algorithms to further prove the utility of the reverse-simulation approach.
